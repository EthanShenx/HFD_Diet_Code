...
# Subset for ND
hfd = adata[adata.obs['orig.ident'] == 'ND'].copy()

# Ensure cell_type is categorical for both datasets
adata.obs['cell_type'] = adata.obs['cell_type'].astype('category')
hfd.obs['cell_type'] = hfd.obs['cell_type'].astype('category')

scv.pl.proportions(hfd, groupby='cell_type', save='proportions_ND.svg')

hfd_palette = {
    "HormSens": "#8DD3C7",   # Set3[1]
    "Basal"   : "#FFFFB3",   # Set3[2]
    "LumProg" : "#BEBADA",   # Set3[3]
    "Adipo"   : "#FB8072",    # 对应 Set3[8]
}
...
plt.savefig('ND_celltypes_umap.svg', bbox_inches='tight')
plt.close()
...
# Save figure
plt.savefig('ND_proportions_with_legend.svg', bbox_inches='tight')
plt.close()
...
scv.pl.velocity_embedding(
    ...
    save='ND_velocity_embedding_points.svg'
)
...
scv.pl.velocity_embedding_grid(
    ...
    save='ND_velocity_embedding_grid.svg'
)
