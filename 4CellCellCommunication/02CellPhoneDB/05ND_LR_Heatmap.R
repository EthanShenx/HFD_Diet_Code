...
means <- fread("D:/data/23BMI/ND_HFD_MG_snRNAseq/cellphonedb/result/statistical_analysis_ND/statistical_analysis_means_10_09_2025_111348.txt")
pvals <- fread("D:/data/23BMI/ND_HFD_MG_snRNAseq/cellphonedb/result/statistical_analysis_ND/statistical_analysis_pvalues_10_09_2025_111348.txt")
sig   <- fread("D:/data/23BMI/ND_HFD_MG_snRNAseq/cellphonedb/result/statistical_analysis_ND/statistical_analysis_significant_means_10_09_2025_111348.txt")
...
# 8. 定义顺序 & 调色板
cell_order  <- c("Adipo","LumProg","HormSens","Stroma","Immune")
