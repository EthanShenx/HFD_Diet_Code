...
seu <- combine
target_ids <- c("Stroma_0","Stroma_1","Stroma_2", "Stroma_3", "Stroma_4")
...
top_row    <- p1 + p3 + plot_layout(ncol = 2, widths = c(2.5, 0.5))
bottom_row <- p2 + plot_layout(ncol = 2, widths = c(2.5, 2)) + plot_spacer()

final_plot <- top_row / bottom_row + plot_layout(heights = c(2,2))
final_plot
