...
gsm_ids <- paste0("GSM", 2512829:2513049)
...
seurat_obj <- CreateSeuratObject(counts = expr_mat,
                                 project = "GSM2512829-GSM2513049",
                                 min.cells = 3,
                                 min.features = 200)

seurat_obj[["percent.mt"]] <- PercentageFeatureSet(seurat_obj, pattern = "^mt-")

GSM2512829_GSM2513049_pre <- seurat_obj

GSM2512829_GSM2513049_pre@meta.data$stage <- "puberty"
GSM2512829_GSM2513049_pre@meta.data$platform <- "fluidigm"

GSM2512829_GSM2513049_pre@meta.data$stage <- as.factor(GSM2512829_GSM2513049_pre@meta.data$stage)
GSM2512829_GSM2513049_pre@meta.data$platform <- as.factor(GSM2512829_GSM2513049_pre@meta.data$platform)

saveRDS(GSM2512829_GSM2513049_pre, file = "GSM2512829_GSM2513049_pub.rds")
