...
GSM2510964_GSM2511099_pre <- seurat_obj

GSM2510964_GSM2511099_pre@meta.data$stage <- "puberty"
GSM2510964_GSM2511099_pre@meta.data$platform <- "fluidigm"

GSM2510964_GSM2511099_pre@meta.data$stage <- as.factor(GSM2510964_GSM2511099_pre@meta.data$stage)
GSM2510964_GSM2511099_pre@meta.data$platform <- as.factor(GSM2510964_GSM2511099_pre@meta.data$platform)

saveRDS(GSM2510964_GSM2511099_pre, file = "GSM2510964_GSM2511099_pub.rds")
